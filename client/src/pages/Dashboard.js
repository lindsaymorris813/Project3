            ...
            <div className="row ">
              ...
              <div className="col shadow p-3 m-3 rounded list-border recipe-list">
                ...
                {userRecipes && userRecipes.map((recipe) => (
                  <RecipeCard key={recipe._id} _id={recipe._id} title={recipe.title} prep={recipe.prep} ingredients={recipe.ingredients} categories={recipe.categories} getRecipes={getRecipes}/>
                ))}
              </div>
            </div>
          </div>
